<section style="min-height: calc(100vh - 83px);" id="about" class="light-bg">
			<div class="container">
				<div class="row">
			...
			<div class="container">
				<ul class="nav nav-tabs">
					<li class="active"><a data-toggle="tab" href="#tab_courses" role="tab">Cursos</a></li>
					<li><a data-toggle="tab" href="#tab_team" role="tab">Equipe</a></li>
					<li><a data-toggle="tab" href="#tab_user" role="tab">Usuários</a></li>					
				</ul>
				<div class="tab-content">
					<div id="tab_courses" class="tab-pane active">
						<div class="container-fluid">
							...
							<table id="dt_courses" class="table table-striped table-bordered">
								...
								<tbody>
									<!-- Os dados dos cursos serão carregados aqui via AJAX -->
								</tbody>
							</table>
						</div>
					</div>
					...
					<div id="tab_team" class="tab-pane">
						<div class="container-fluid">
							...
							<a href="#" id="btn_add_member" class="btn btn-primary"><i class="fa fa-plus"> Adicionar Time</i></a>
					...
					<div class="modal-body">
						<form id="form_course">
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input class="form-control" name="course_name" id="course_name" maxlength="100">
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<img src="" alt="" id="course_img_path" style="max-width: 400px; max-height: 400px;">
									<label class="btn btn-block btn-info">
										<i class="fa fa-upload"></i> Importar imagem
										<input type="file" name="course_img" id="btn_upload_course_img" accept="image/*" style="display: none;">
									</label>
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input type="number" min="0" class="form-control" name="course_duration" id="course_duration">
									<span class="help-block"></span>
								</div>
							</div>
					...
					<div class="modal-body">
						<form id="form_member">
							...
							<div class="form-group">
								<label class="col-lg-2 control-label">Nome</label>
								<div class="col-lg-10">
									<input class="form-control" name="member_name" id="member_name" maxlength="100">
									<span class="help-block"></span>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<img src="" alt="" id="member_photo_path" style="max-width: 400px; max-height: 400px;">
									<label class="btn btn-block btn-info">
										<i class="fa fa-upload"></i> Importar Foto
										<input type="file" name="member_photo" id="btn_upload_member_photo" accept="image/*" style="display: none;">
									</label>
							...
							<div class="form-group">
								<label class="col-lg-2 control-label">Duração</label>
								<div class="col-lg-10">
									<input type="number" min="0" class="form-control" name="member_duration" id="member_duration">
									<span class="help-block"></span>
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-lg-2 control-label">Descrição</label>
								<div class="col-lg-10">
									<textarea class="form-control" name="member_description" id="member_description">
									</textarea>
									<span class="help-block"></span>
								</div>
							</div>
							...
							<div class="form-group text-center">
								<button type="submit" class="btn btn-primary" id="btn_save_member">
									<i class="fa fa-save"></i> Salvar
								</button>
								<span class="help-block"></span>
							</div>
					...
					<div class="modal-body">
						<form id="form_user">
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input class="form-control" name="user_login" id="user_login" maxlength="30">
									<span class="help-block"></span>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input class="form-control" name="user_full_name" id="user_full_name" maxlength="100">
									<span class="help-block"></span>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
								<input type="email"class="form-control" name="user_email_confirm" id="user_email_confirm">
									<span class="help-block"></span>
								</div>
							</div>
